...
| RFC-017 | Value Provenance Framework | **Phase 1 merged 2026-08-10**; architecture frozen at `b8cc0ed`; **OBS-017-A remediation ready for TELMU validation** (GD-A1–GD-A7); **Phases 2–5 unauthorised** | [`RFC-017-value-provenance-framework.md`](RFC-017-value-provenance-framework.md) | [`rfc-017-phase-1-implementation-report.md`](../rfc-017-phase-1-implementation-report.md); [`rfc-017-phase-1-conformance-remediation-report.md`](../rfc-017-phase-1-conformance-remediation-report.md) | self-review [`RFC-017-architecture-self-review.md`](../reviews/RFC-017-architecture-self-review.md); freeze record [`RFC-017-architecture-freeze-record.md`](../reviews/RFC-017-architecture-freeze-record.md); SAFE review [`RFC-017-safe-review.md`](../reviews/RFC-017-safe-review.md); SAFE confirmation [`RFC-017-safe-confirmation.md`](../reviews/RFC-017-safe-confirmation.md); OBS-017-A investigation [`RFC-017-OBS-017-A-clarification.md`](../reviews/RFC-017-OBS-017-A-clarification.md); OBS-017-A ruling [`RFC-017-OBS-017-A-ruling.md`](../reviews/RFC-017-OBS-017-A-ruling.md); technical debt [`rfc-017-technical-debt.md`](../rfc-017-technical-debt.md) | [#45](https://github.com/enipeus84/foundry/pull/45), [#46](https://github.com/enipeus84/foundry/pull/46) |
