...
| RFC-011 | Asset & Telemetry Acquisition Framework | **Proposed — awaiting Governor review** | [`RFC-011-asset-telemetry-acquisition-framework.md`](RFC-011-asset-telemetry-acquisition-framework.md) | — | — |
